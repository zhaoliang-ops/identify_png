...
var filenames = []string{
	"/home/max/max/workplace/repaire_png/errpng/00.jpg",
	"/home/max/max/workplace/repaire_png/errpng/01.jpg",
	"/home/max/max/workplace/repaire_png/errpng/02.jpg",
	"/home/max/max/workplace/repaire_png/errpng/03.jpg",
	"/home/max/max/workplace/repaire_png/errpng/04.jpg",
	"/home/max/max/workplace/repaire_png/errpng/05.jpg",
}
...
func main() {
	...
	for _, fn := range names {
		// fmt.Println(fn)
		// img, err := readPNG(fn)
		_, err := imaging.Open(fn)
		if err != nil {
			fmt.Println(err, "failed", fn)
			continue
		}
		fmt.Println(err, "successed!", fn)
	}
	// filepath := "errpng/de9868ae7f99422ab2d283af1df88c87.png"
	// filepath := "errpng/b1343e43c0f14b03881af41f460943fd.png"
	// _, err := imaging.Open(filepath)
	// if err != nil {
	// 	fmt.Println(err, "failed1")
	// }
	// _, err1 := readPNG(filepath)
	// if err1 != nil {
	// 	fmt.Println(err1, "failed2")
	// 	os.Exit(-1)
	// }
	// fmt.Println(err, "successed!")
}
